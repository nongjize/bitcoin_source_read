...
public:
	...
	//pseudo random noise generation pseudo random noise generation prng

    // Generate a new private key using a cryptographic PRNG.//pseudo Random Noise Generation
