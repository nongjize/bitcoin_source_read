...
#pragma region 第三步
    ...
    setvbuf(stdout, NULL, _IOLBF, INT_MAX);
#ifdef ENABLE_WALLET
...
#pragma endregion
        ...
        if (!fLoaded) 
		{
#pragma region firstsuggestareindex)
...
#pragma region 第八步
#ifdef ENABLE_WALLET
    if (fDisableWallet) //fdisablewallet 定义在第三步
	{
        pwalletMain = NULL;
